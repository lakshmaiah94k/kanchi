    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='college.Department')),
                ('student_apps', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='college.StudentApp')),
